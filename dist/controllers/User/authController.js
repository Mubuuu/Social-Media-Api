...
exports.default = {
    ...
    //@access public
    postRegister: (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //@access public
    googleLogin: (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const userVerify = yield userModel_1.default.findOne({
    ...
    //@access private
    changePassword: (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
